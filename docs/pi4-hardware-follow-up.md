...
- The tester changed scaling from 2× to 1×, but the display still does not appear to use the monitor's full resolution. Actual pixel dimensions, refresh rate, supported modes, and the monitor model remain to be collected.
